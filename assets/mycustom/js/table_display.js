var table_room =  $('.table_room').DataTable({
		...
		buttons: [
			...
			},
			{
				...
				message: '<img src="https://images.seeklogo.com/logo-png/51/1/amrita-vishwa-vidyapeetham-logo-png_seeklogo-519921.png" height="100px" width="100px" style="position: absolute;top:0;left:80px;"><center><h4 style="margin-top:-40px;">COIMBATORE, INDIA</h4>\
	...
	"ajax":
		...
		buttons: [
			...
			},
			{
				...
				message: '<img src="https://images.seeklogo.com/logo-png/51/1/amrita-vishwa-vidyapeetham-logo-png_seeklogo-519921.png" height="100px" width="100px" style="position: absolute;top:0;left:80px;"><center><h4 style="margin-top:-40px;">REPUBLIC OF THE PHILIPPINES</h4>\
							<h5>AMRITA VISHWA VIDYAPEETHAM</h5>\
							<h6>COMPUTER SCIENCE AND ENGINEERING</h6>\
							</center>',
				customize: function ( win ) {
